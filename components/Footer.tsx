    ...
    <footer className="bg-[#0e1117] border-t border-[#2a2d33]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div>
            <h4 className="text-[#f2f2f2] font-semibold mb-4 text-sm">Contact</h4>
            <p className="text-[#84878b] text-sm mb-4">Available 24/7 for your booking needs</p>
            <a href="https://wa.me/2348107837959" target="_blank" rel="noopener noreferrer" className="inline-block bg-[#F8AC28] text-[#0a0e13] px-5 py-2.5 rounded-[32px] text-sm font-semibold hover:bg-[#e69d1f] transition-colors duration-200">
              WhatsApp Us
            </a>
          </div>
        </div>

...
Message: ${message}`
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 px-4">
      <div className="bg-[#0e1117] rounded-xl border border-[#2a2d33] w-full max-w-lg max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          <div>
            ...
            <input required value={name} onChange={(e) => setName(e.target.value)} className="w-full bg-[#0a0e13] border border-[#2a2d33] rounded px-3 py-2 text-white focus:outline-none focus:border-[#F8AC28]" />
          </div>
          <div>
            <label className="block text-sm text-white/70 mb-1">Phone *</label>
            <input required type="tel" value={phone} onChange={(e) => setPhone(e.target.value)} className="w-full bg-[#0a0e13] border border-[#2a2d33] rounded px-3 py-2 text-white focus:outline-none focus:border-[#F8AC28]" />
          </div>
          <div>
            <label className="block text-sm text-white/70 mb-1">Email</label>
            <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} className="w-full bg-[#0a0e13] border border-[#2a2d33] rounded px-3 py-2 text-white focus:outline-none focus:border-[#F8AC28]" />
          </div>
          <div>
            <label className="block text-sm text-white/70 mb-1">City *</label>
            <select required value={city} onChange={(e) => setCity(e.target.value)} className="w-full bg-[#0a0e13] border border-[#2a2d33] rounded px-3 py-2 text-white focus:outline-none focus:border-[#F8AC28]">
          ...
          <div>
            ...
            <textarea rows={3} value={message} onChange={(e) => setMessage(e.target.value)} className="w-full bg-[#0a0e13] border border-[#2a2d33] rounded px-3 py-2 text-white focus:outline-none focus:border-[#F8AC28]" />
          </div>

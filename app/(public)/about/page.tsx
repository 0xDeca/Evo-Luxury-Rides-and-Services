      ...
      <section className="pt-32 pb-16 bg-luxury-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl sm:text-5xl font-bold mb-4">
            Explore the world of <span className="text-luxury-gold">Luxury</span>
          </h1>
      ...
      <section className="py-16 bg-luxury-800">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-2xl font-bold mb-4">Our <span className="text-luxury-gold">Story</span></h2>
            ...
            <div>
              <h2 className="text-2xl font-bold mb-4">Mission &amp; <span className="text-luxury-gold">Vision</span></h2>
      ...
      <section className="py-16 bg-luxury-900">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl font-bold text-center mb-12">
            Our Impact in <span className="text-luxury-gold">Numbers</span>
          </h2>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-6">
            {stats.map((s) => (
              <div key={s.l} className="text-center bg-luxury-800 border border-luxury-700 rounded-xl p-6">
                <p className="text-3xl sm:text-4xl font-bold text-luxury-gold">{s.n}</p>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={i} className="flex items-start gap-4 bg-luxury-900 border border-luxury-700 rounded-xl p-5">
                <div className="w-8 h-8 bg-luxury-gold/10 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5">
                  <svg className="w-4 h-4 text-luxury-gold" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg>
                </div>
                <div>
      ...
      <section className="py-16 bg-luxury-900">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl font-bold text-center mb-10">
            What <span className="text-luxury-gold">Drives Us</span>
          </h2>
          <div className="grid sm:grid-cols-3 gap-6">
            {values.map((v) => (
              <div key={v.title} className="bg-luxury-800 border border-luxury-700 rounded-xl p-6">
      ...
      <section className="py-16 bg-luxury-800">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {team.map((m) => (
              <div key={m.name} className="bg-luxury-900 border border-luxury-700 rounded-xl p-6 text-center">
                <div className="w-16 h-16 bg-luxury-gold/10 rounded-full flex items-center justify-center mx-auto mb-4">
                  <span className="text-2xl text-luxury-gold font-bold">{m.name.charAt(0)}</span>
                </div>
      ...
      <section className="py-16 bg-luxury-900 text-center">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl font-bold mb-4">
            Ready to Experience <span className="text-luxury-gold">Luxury</span>?
          </h2>
          <p className="text-white/50 mb-6">Contact us today to book your dream car or premium apartment.</p>
          <Link href="/cars" className="inline-block bg-luxury-gold text-luxury-900 px-8 py-3 rounded font-semibold hover:bg-luxury-gold-light transition-colors">
            Book Now
          </Link>
        </div>
      </section>

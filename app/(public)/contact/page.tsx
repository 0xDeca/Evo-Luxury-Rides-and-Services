      ...
      <section className="pt-32 pb-16 bg-luxury-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl sm:text-5xl font-bold mb-4">
            Let&apos;s Make Your <span className="text-luxury-gold">Booking</span> Seamless
          </h1>
      ...
      <section className="pb-20 bg-luxury-900">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-10">
          <div className="space-y-6">
            <div className="bg-luxury-800 border border-luxury-700 rounded-xl p-6">
              <p className="text-white/50 text-sm mb-1">Phone / WhatsApp</p>
              <a href="https://wa.me/2348107837959" className="text-luxury-gold text-lg font-semibold hover:text-luxury-gold-light transition-colors">0810 783 7959</a>
            ...
            <div className="rounded-xl overflow-hidden h-56 border border-luxury-700">
          ...
          <form onSubmit={handleSubmit} className="bg-luxury-800 border border-luxury-700 rounded-xl p-6 space-y-4">
            <h2 className="text-xl font-bold mb-2">Send us a <span className="text-luxury-gold">Message</span></h2>
            ...
            <div>
              ...
              <input required value={name} onChange={(e) => setName(e.target.value)} className="w-full bg-luxury-900 border border-luxury-600 rounded px-3 py-2.5 text-white focus:outline-none focus:border-luxury-gold text-sm" />
            </div>
            <div>
              <label className="block text-sm text-white/60 mb-1">Email</label>
              <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} className="w-full bg-luxury-900 border border-luxury-600 rounded px-3 py-2.5 text-white focus:outline-none focus:border-luxury-gold text-sm" />
            </div>
            <div>
              <label className="block text-sm text-white/60 mb-1">Phone *</label>
              <input required type="tel" value={phone} onChange={(e) => setPhone(e.target.value)} className="w-full bg-luxury-900 border border-luxury-600 rounded px-3 py-2.5 text-white focus:outline-none focus:border-luxury-gold text-sm" />
            </div>
            <div>
              <label className="block text-sm text-white/60 mb-1">Message *</label>
              <textarea required rows={4} value={message} onChange={(e) => setMessage(e.target.value)} className="w-full bg-luxury-900 border border-luxury-600 rounded px-3 py-2.5 text-white focus:outline-none focus:border-luxury-gold text-sm" />
            </div>

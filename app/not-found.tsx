  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-luxury-900 px-4">
      <div className="text-center">
        ...
        <a href="/" className="inline-block bg-luxury-gold text-luxury-900 px-8 py-3 rounded font-semibold hover:bg-luxury-gold-light transition-colors">Back to Home</a>
      </div>
    </div>
  )
}